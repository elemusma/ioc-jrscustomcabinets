...
function jrs_custom_cabinets_stylesheets() {
...
if( is_front_page() ){
	wp_enqueue_style('about-tabs', get_theme_file_uri('/css/sections/about-tabs.css'));
}
...
add_action('wp_enqueue_scripts', 'jrs_custom_cabinets_stylesheets');
// for footer
function jrs_custom_cabinets_stylesheets_footer() {
...
add_action('get_footer', 'jrs_custom_cabinets_stylesheets_footer');
...
function jrs_custom_cabinets_menus() {
...
add_action('after_setup_theme', 'jrs_custom_cabinets_menus');
